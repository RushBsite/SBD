...
function AddressPage3({setModal}) {
    ...
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column'}}>
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ position: 'absolute', bottom: '-10%', transform: 'translate(-50%, -50%)', left: '50%', width: '30%', minWidth:'200px', backgroundColor: 'white', zIndex: 1, padding: '10px', borderRadius: '10%', textAlign: 'center'}}>
          ...
          <div id="button-box">
           <Link to="/index"><button onClick={saveData} id="accept" style={{padding: '15px 50px 15px 50px', borderRadius: '15px', backgroundColor: '#06f', fontSize: 'medium', color: 'white', outline: '0', borderColor: 'white'}}>이 위치로 지정</button></Link> 
          </div>
        </div>
      </div>
    </div>
